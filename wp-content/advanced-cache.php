...
$possible_plugin_locations = array(
	...
	'/home1/jma2020/legacycenter/wp-content/plugins/wp-optimize/cache',
);
...
if (false !== $plugin_location) {
	...
	if (!defined('WPO_CACHE_EXT_DIR')) define('WPO_CACHE_EXT_DIR', '/home1/jma2020/legacycenter/wp-content/plugins/wp-optimize/cache/extensions');
}

if (!@file_exists(WPO_CACHE_CONFIG_DIR . '/config-legacycenter.com.php')) { return; }

$GLOBALS['wpo_cache_config'] = json_decode(file_get_contents(WPO_CACHE_CONFIG_DIR . '/config-legacycenter.com.php'), true);
